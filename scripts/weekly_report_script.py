...
def generate_html_email_template(recipient_name, report_data):
    ...
    <head>
        ...
        <title>Weekly Invoice Follow-Up Report</title>
    </head>
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f8fafc; margin: 0; padding: 20px;">
        ...
        <div style="max-width: 800px; margin: 0 auto; background: white; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
            ...
            <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px; text-align: center;">
                <h1 style="margin: 0 0 10px 0; font-size: 28px; font-weight: 700;">📊 Weekly Invoice Follow-Up Report</h1>
            ...
            <div style="padding: 0 30px 20px 30px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr; gap: 15px; margin-bottom: 30px; max-width: 400px; margin-left: auto; margin-right: auto;">
                    ...
                    <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border: 1px solid #f59e0b; border-radius: 10px; padding: 20px; text-align: center;">
                        <div style="font-size: 24px; font-weight: 700; color: #d97706; margin-bottom: 5px;">{report_data['total_clients']}</div>
                        <div style="font-size: 14px; color: #92400e; font-weight: 600;">Affected Clients</div>
                    </div>
...
def send_weekly_report_email(config, report_data):
    ...
    try:
        ...
        try:
            # Create subject
            subject = f"Weekly Invoice Follow-Up Report - {datetime.now().strftime('%Y-%m-%d')}"
